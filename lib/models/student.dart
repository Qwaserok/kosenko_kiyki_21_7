...
class Student {
  ...
  static Department getDepartment(String departmentString) {
  ...
  static String departmentPut(Department department) {
    ...
    for (final item in data.entries) {
      loadedItems.add(
        Student(
          ...
          department: getDepartment(item.value['department']!),
      ...
      body: json.encode(
        {
          ...
          'last_name': lastName,
          'department': departmentPut(department),
